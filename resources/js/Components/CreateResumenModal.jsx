...
export default function CreateResumenModal({ isOpen, onClose, onSubmit, form }) {
    ...
    useEffect(() => {
        setStock((form.data.ingresos || 0) - (form.data.salidas || 0));
                    ...
                    <form onSubmit={onSubmit} className="flex-1 overflow-y-auto p-6">
                        ...
                        <div className={sectionClass}>
                            ...
                            <div className={gridClass}>
                                <div>
                                    ...
                                    <input type="number" value={form.data.item} onChange={(e) => form.setData('item', e.target.value)} className={inputClass} required />
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" value={form.data.especie} onChange={(e) => form.setData('especie', e.target.value)} className={inputClass} required />
                                </div>
                                <div>
                        ...
                        <div className={sectionClass}>
                            ...
                            <div className={gridClass}>
                                <div>
                                    ...
                                    <input type="text" value={form.data.calidad} onChange={(e) => form.setData('calidad', e.target.value)} className={inputClass} required />
                                </div>
                                <div>
                                    <label className={labelClass}>Estado</label>
                                    <input type="text" value={form.data.estado} onChange={(e) => form.setData('estado', e.target.value)} className={inputClass} placeholder="IQF" />
                                </div>
                                <div>
                                    <label className={labelClass}>Talla *</label>
                                    <input type="text" value={form.data.talla} onChange={(e) => form.setData('talla', e.target.value)} className={inputClass} required />
                                </div>
                                <div>
                                    <label className={labelClass}>Empaque *</label>
                                    <input type="text" value={form.data.empaque} onChange={(e) => form.setData('empaque', e.target.value)} className={inputClass} required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={sectionClass}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                <div>
                                    <label className={labelClass}>Ingresos</label>
                                    <input type="number" value={form.data.ingresos} onChange={(e) => form.setData('ingresos', parseInt(e.target.value) || 0)} className={inputClass} />
                                </div>
                                <div>
                                    <label className={labelClass}>Salidas</label>
                                    <input type="number" value={form.data.salidas} onChange={(e) => form.setData('salidas', parseInt(e.target.value) || 0)} className={inputClass} />
                                </div>
                                <div>
                                    <label className={labelClass}>Stock</label>
                                    <input type="text" value={stock} className={`${inputClass} bg-gray-50 dark:bg-gray-600 cursor-not-allowed text-gray-500`} readOnly />
                                </div>
                                <div>
                                    <label className={labelClass}>LB</label>
                                    <input type="text" value={form.data.lb} onChange={(e) => form.setData('lb', e.target.value)} className={inputClass} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={sectionClass}>
                            ...
                            <div>
                                <label className={labelClass}>Observación Organoléptica</label>
                                <textarea
                                    value={form.data.observacion_organoleptica}
                                    onChange={(e) => form.setData('observacion_organoleptica', e.target.value)}
