...
export default function CreateSalidaModal({ isOpen, onClose, onSubmit, form, caja2, promedio }) {
                    ...
                    <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                                Complete la información de la salida de producto
                            </p>
                        </div>
                        <button
                            onClick={onClose}
                        ...
                        <div className={sectionClass}>
                            ...
                            <div className={gridClass}>
                                ...
                                <div>
                                    ...
                                    <input type="text" value={form.data.lote} onChange={(e) => form.setData('lote', e.target.value)} className={inputClass} placeholder="61/25" required />
                                </div>
                                <div>
                                    <label className={labelClass}>Código *</label>
                                    <input type="text" value={form.data.codigo} onChange={(e) => form.setData('codigo', e.target.value)} className={inputClass} placeholder="081402070201" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={sectionClass}>
                            ...
                            <div className={gridClass}>
                                ...
                                <div>
                                    ...
                                    <input type="text" value={form.data.producto} onChange={(e) => form.setData('producto', e.target.value)} className={inputClass} placeholder="FILETE CON PIEL, SIN ESPINAS CO" required />
                                </div>
                                <div>
                        ...
                        <div className={sectionClass}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" value={caja2 || form.data.caja || 0} className={`${inputClass} bg-gray-50 dark:bg-gray-600 cursor-not-allowed text-gray-500`} readOnly />
                                </div>
                                <div>
                    ...
                    <div className="px-6 py-4 bg-gray-50 dark:bg-gray-750 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <button type="submit" onClick={onSubmit} disabled={form.processing} className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium text-sm shadow-sm">
                                {form.processing ? 'Guardando...' : 'Guardar Salida'}
                            </button>
                        </div>
                    </div>
                </div>
