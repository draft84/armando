...
export default function ImportExcelModal({ isOpen, onClose, onSubmit, isSubmitting }) {
    ...
    const handleSubmit = () => {
        ...
        if (isSubmitting) {
            console.warn('Ya se está procesando una importación');
            return;
        }

        console.log('✅ Llamando a onSubmit con el archivo:', selectedFile.name);
                ...
                <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-lg w-full overflow-hidden">
                    ...
                    <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                        <div className="flex items-center justify-between">
                            ...
                            <button onClick={onClose} disabled={isSubmitting} className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-all disabled:opacity-50">
                    ...
                    <div className="p-6 bg-white dark:bg-gray-800">
                        ...
                        <div
                            ...
                            onDragOver={(e) => { if (!isSubmitting) { e.preventDefault(); setDragOver(true); } }}
                            onDragLeave={() => setDragOver(false)}
                            onDrop={(e) => { if (!isSubmitting) { handleDrop(e); } }}
                        >
                            <ArrowUpTrayIcon className="w-10 h-10 mx-auto text-gray-400 mb-3" />
                            <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                {isSubmitting ? 'Procesando archivo...' : 'Arrastra tu archivo Excel aquí'}
                            </p>
                            ...
                            {!isSubmitting && (
                                <label className="inline-block">
                                    <input type="file" accept=".xlsx,.xls,.csv" onChange={(e) => handleFileChange(e.target.files[0])} className="hidden" disabled={isSubmitting} />
                        ...
                        <div className="flex items-center justify-end space-x-3 mt-6">
                            <button 
                                ...
                                className="px-4 py-2 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 rounded-lg transition-all font-medium text-sm disabled:opacity-50"
                            >
                            ...
                            <button 
                                ...
                                className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium text-sm shadow-sm flex items-center"
                            >
                                {isSubmitting ? (
                                    <>
