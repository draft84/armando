...
export default function EditSalidaModal({ isOpen, onClose, onSubmit, form }) {
    const inputClass = "w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all duration-200 text-sm";
                ...
                <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-7xl w-full max-h-[90vh] overflow-hidden flex flex-col">
                    ...
                    <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                                Modificar información de la salida
                            </p>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <form onSubmit={onSubmit} className="flex-1 overflow-y-auto p-6">
                        ...
                        <div className={sectionClass}>
                            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Información Básica</h3>
                            <div className={gridClass}>
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local" value={form.data.fecha} onChange={(e) => form.setData('fecha', e.target.value)} className={inputClass} required />
                                </div>
                                <div>
                                    <label className={labelClass}>Lote *</label>
                                    <input type="text" value={form.data.lote} onChange={(e) => form.setData('lote', e.target.value)} className={inputClass} required />
                                </div>
                                <div>
                                    <label className={labelClass}>Código *</label>
                                    <input type="text" value={form.data.codigo} onChange={(e) => form.setData('codigo', e.target.value)} className={inputClass} required />
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Sección 2 */}
                        <div className={sectionClass}>
                            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Producto</h3>
                            <div className={gridClass}>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" value={form.data.producto} onChange={(e) => form.setData('producto', e.target.value)} className={inputClass} required />
                                </div>
                                <div>
                        ...
                        {/* Sección 3 */}
                        <div className={sectionClass}>
                            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Cantidades y Pesos</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                                <div>
                                    <label className={labelClass}>Caja *</label>
                                    <input type="number" value={form.data.caja} onChange={(e) => form.setData('caja', e.target.value)} className={inputClass} required />
                                </div>
                                <div>
                        ...
                        {/* Sección 4 */}
                        <div className={sectionClass}>
                            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Fechas</h3>
                        ...
                        {/* Sección 5 */}
                        <div className={sectionClass}>
                            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Almacenamiento</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                                <div>
                        ...
                        {/* Sección 6 */}
                        <div className={sectionClass}>
                            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">Cliente y Documento</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className={labelClass}>Cliente</label>
                                    <input type="text" value={form.data.cliente} onChange={(e) => form.setData('cliente', e.target.value)} className={inputClass} placeholder="TROPIMAR" />
                                </div>
                                <div>
                                    <label className={labelClass}>N° Doc</label>
                                    <input type="text" value={form.data.ndoc} onChange={(e) => form.setData('ndoc', e.target.value)} className={inputClass} placeholder="327" />
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <div className="px-6 py-4 bg-gray-50 dark:bg-gray-750 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <button type="submit" onClick={onSubmit} disabled={form.processing} className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium text-sm shadow-sm">
                                {form.processing ? 'Actualizando...' : 'Actualizar Salida'}
                            </button>
                        </div>
                    </div>
                </div>
